export const messages = {
  ...
  fr: {
    ...
    'Practice language': 'Langue de pratique',
    'Start': 'Démarrer',
    'Score': 'Score',
  ...
  km: {
    ...
    'Practice language': 'ភាសាសម្រាប់ហ្វឹកហាត់',
    'Start': 'ចាប់ផ្តើម',
    'Score': 'ពិន្ទុ',
    ...
    highScores: {
      title: 'ពិន្ទុខ្ពស់',
      description: 'លទ្ធផលដ៏ល្អបំផុតរបស់អ្នក។',
      accuracy: 'នៅក្នុងលក្ខខណ្ឌនៃភាពត្រឹមត្រូវ - ',
      speed: 'នៅក្នុងលក្ខខណ្ឌនៃល្បឿន - ',
      notPlayed: "អ្នកមិនទាន់លេងនៅឡើយទេ។",
      visualKeyboard: 'អ្នកបានសរសេរចំនួន {runes} តួរអក្សរ នៅក្នុងរយះពេល {time} នាទី ដោយបានបង្កើតកំហុងឆ្គងចំនួន {errors} ។',
      typefast: 'អ្នកសរសេរបានចំនួន {score} ពាក្យ នៅក្នុងរយះពេលមួយនាទី។'
    },
